#ifndef PATH_SYNC_WEIGHTED_SUM_ASTAR_HPP
#define PATH_SYNC_WEIGHTED_SUM_ASTAR_HPP
...
class WeightedSumAStar : public ISolver
{
public:
    WeightedSumAStar();
...
private:
    std::string solver_name_ = "WeightedSumAStar";
...
#endif // PATH_SYNC_WEIGHTED_SUM_ASTAR_HPP
